...
public class CommandCreateDebug implements CommandHandler {
    ...
    private File getFolder(String path) {
        path = Application.getInstance().getGlobal().getCustomConfig().getDebug() + path.replace("::", "\\");
